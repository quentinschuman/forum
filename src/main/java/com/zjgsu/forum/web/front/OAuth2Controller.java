...
import com.zjgsu.forum.module.user.service.OAuth2UserService;
...
public class OAuth2Controller extends BaseController {
    ...
    public String githubLogin(HttpSession session){
        ...
        String url = "https://github.com/login/oauth/authorize?client_id=" + siteConfig.getOauth2().getGithub().getClientId() + "&redirect_uri=" + siteConfig.getOauth2().getGithub().getCallbackUrl() + "&scope=user" + "&state=" + state;
        return "redirect:" + url;
    }
