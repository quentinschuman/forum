...
import com.zjgsu.forum.module.security.repository.PermissionRepository;
        ...
        permissions.forEach(permission -> {
            ...
            if (permission.getPid() == 0){
                ...
                childPermissions.forEach(childPermission ->{
                    ...
                    childMap2.put("text",permission.getName());
                    childMap2.put("pid",permission.getPid());
                    childMap2.put("id",permission.getId());
                    childMap2.put("value",permission.getValue());
                    childMap2.put("url",permission.getUrl());
